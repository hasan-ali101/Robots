...
export default function Home() {
  ...
  return (
    <>
      <div className="flex border-white border-x-8 border-b-8 flex-col justify-center h-screen w-screen">
        ...
        <div className="flex justify-center h-full w-full flex-col md:flex-row">
          <div className="relative h-[60%] md:h-full w-full md:w-7/12 max-w-[700px] flex items-center justify-center bg-trasparent overflow-hidden">
          ...
          <div className="bg-[#e5c7c5] border-white border-t-8 md:border-t-0 md:border-l-8 flex-1"></div>
        </div>
      </div>
    </>
  );
